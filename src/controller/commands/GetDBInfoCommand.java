...
public class GetDBInfoCommand extends Commands {
	private Model model;
	private View view;
	private ClientHandler cli;

	public GetDBInfoCommand(Model model, View view) {
		this.model = model;
		this.view = view;
	}
	public GetDBInfoCommand(Model model, View view,ClientHandler cli) {
		this.model = model;
		this.view = view;
		this.cli=cli;
	}
